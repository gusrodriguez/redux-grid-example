...
var _require = __webpack_require__(3),
    FETCH_USERS = _require.FETCH_USERS,
    SELECTED_USER = _require.SELECTED_USER,
    CLEAR = _require.CLEAR,
    ADD_USER = _require.ADD_USER,
    EDIT_USER = _require.EDIT_USER,
    EDITED_USER = _require.EDITED_USER,
    DELETE_USER = _require.DELETE_USER,
    DELETED_USER = _require.DELETED_USER,
    ADDED_USER = _require.ADDED_USER,
    CLOSE_MESSAGE = _require.CLOSE_MESSAGE,
    VALIDATION_ERROR = _require.VALIDATION_ERROR,
    SORT = _require.SORT;

var fetchUsers = function fetchUsers() {
  return async function (dispatch) {
    var res = await axios.get(config.apiBaseUrl + '/api/users');
    dispatch({
      type: FETCH_USERS,
      payload: res
    });
...
var selectedUser = function selectedUser(user) {
  return {
    type: SELECTED_USER,
    payload: user
  };
...
var addUser = function addUser(user) {
  return async function (dispatch) {
    try {
      var res = await axios.post(config.apiBaseUrl + '/api/users', user, { headers: { 'Content-Type': 'application/json' } });
      dispatch({
        type: ADD_USER,
        payload: res
      });
...
var editUser = function editUser(user) {
  return async function (dispatch) {
    var res = await axios.put(config.apiBaseUrl + '/api/users', user, { headers: { 'Content-Type': 'application/json' } });
    dispatch({
      type: EDIT_USER,
      payload: res
    });
...
var deleteUser = function deleteUser(user) {
  return async function (dispatch) {
    var res = await axios.delete(config.apiBaseUrl + '/api/users/' + user.email);
    dispatch({
      type: DELETE_USER,
      payload: res
    });
...
// eslint-disable-next-line
var sort = function sort(criteria) {
  return {
    type: SORT,
    payload: criteria
  };
...
var thunk = __webpack_require__(80).default;
...
var _getRawTag = __webpack_require__(59);

var _getRawTag2 = _interopRequireDefault(_getRawTag);

var _objectToString = __webpack_require__(60);
...
var _baseGetTag = __webpack_require__(56);
...
var _isObjectLike = __webpack_require__(63);
...
var aa = __webpack_require__(1),
    l = __webpack_require__(45),
    B = __webpack_require__(17),
    C = __webpack_require__(7),
    ba = __webpack_require__(44),
    da = __webpack_require__(48),
    ea = __webpack_require__(52),
    fa = __webpack_require__(46),
    ia = __webpack_require__(47),
...
var _mapDispatchToProps = __webpack_require__(72);
...
var React = __webpack_require__(1);
var UserForm = __webpack_require__(87);
var UsersList = __webpack_require__(89);
...
function Message(props) {
  return React.createElement(
    'div',
    { className: 'alert ' + props.type + ' alert-dismissible' },
    React.createElement(
      'span',
      { className: 'close', 'data-dismiss': 'alert', 'aria-label': 'close', onClick: props.closeMessage },
      '\xD7'
    ),
    props.text
  );
...
var _require3 = __webpack_require__(2),
    fetchUsers = _require3.fetchUsers;
...
var ReloadButton = function (_React$Component) {
  ...
  _createClass(ReloadButton, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        'svg',
        { onClick: this.reload, className: 'reload ', xmlns: 'http://www.w3.org/2000/svg', width: '24', height: '24', viewBox: '0 0 24 24', style: align },
...
var _require5 = __webpack_require__(2),
    editUser = _require5.editUser;

var _require6 = __webpack_require__(2),
    closeMessage = _require6.closeMessage;
...
var UserForm = function (_React$Component) {
  ...
  _createClass(UserForm, [{
    ...
    value: function render() {
      ...
      var editingLabel = null;
      var message = null;
      if (this.props.editing) {
        editingLabel = React.createElement(
          'span',
          null,
          'Editing user ',
          ...
          React.createElement(
            'a',
            { role: 'link', className: 'link', onClick: function onClick() {
                return _this2.props.clear();
              } },
            'Here to clear and add a new user.'
          )
        );
      }
      if (this.props.addedUser) {
        message = React.createElement(Message, { type: 'alert-success', closeMessage: this.closeMessage, text: 'The new user has been added.' });
      }
      if (this.props.editedUser) {
        message = React.createElement(Message, { type: 'alert-success', closeMessage: this.closeMessage, text: 'The  user has been edited.' });
      }
      if (this.props.deletedUser) {
        message = React.createElement(Message, { type: 'alert-success', closeMessage: this.closeMessage, text: 'The  user has been deleted.' });
      }
      if (this.props.validationError) {
        message = React.createElement(Message, { type: 'alert-danger', closeMessage: this.closeMessage, text: 'Fullname must be unique and email should be valid.' });
      }

      return React.createElement(
        'form',
        { className: 'container user-form', onSubmit: this.submitForm },
        React.createElement(
          'div',
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'col-md-6' },
            React.createElement('input', { type: 'text', size: '50', maxLength: '50', className: 'form-control', name: 'firstname', ref: 'firstname', placeholder: 'First name', pattern: '[a-zA-Z0-9]+', maxlength: '50' })
          ),
          React.createElement(
            'div',
            { className: 'col-md-6' },
            React.createElement('input', { type: 'text', size: '50', maxLength: '50', className: 'form-control', name: 'surname', ref: 'surname', placeholder: 'Surname', pattern: '[a-zA-Z0-9]+', maxlength: '50' })
          )
        ),
        React.createElement(
          'div',
          ...
          React.createElement(
            'div',
            { className: 'col-md-6' },
            React.createElement('input', { type: 'text', size: '50', maxLength: '50', className: 'form-control', name: 'contact_number', ref: 'contact_number', placeholder: 'Contact Number', pattern: '^[0-9+]*$' })
          ),
          React.createElement(
            'div',
            { className: 'col-md-6' },
            React.createElement('input', { type: 'email', size: '50', maxLength: '50', className: 'form-control', name: 'email', ref: 'email', placeholder: 'Email', disabled: this.props.editing, pattern: '[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$' })
          )
        ),
        React.createElement(
          'div',
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ clear: clear, addUser: addUser, editUser: editUser, closeMessage: closeMessage }, dispatch);
}
...
var _require3 = __webpack_require__(2),
    selectedUser = _require3.selectedUser;
...
var UserListItem = function (_React$Component) {
  ...
  function UserListItem(props) {
    ...
    var _this = _possibleConstructorReturn(this, (UserListItem.__proto__ || Object.getPrototypeOf(UserListItem)).call(this, props));
  ...
  _createClass(UserListItem, [{
    ...
    value: function render() {
      ...
      var _props$user = this.props.user,
          ...
          contact_number = _props$user.contact_number,
          email = _props$user.email;

      return React.createElement(
        'div',
        { className: 'row user-list-item', role: 'presentation', onClick: function onClick() {
            return _this2.props.selectedUser(_this2.props.user);
          } },
        React.createElement(
          'div',
          { className: 'col-md-2' },
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ selectedUser: selectedUser, deleteUser: deleteUser }, dispatch);
}
...
module.exports = connect(mapStateToProps, mapDispatchToProps)(UserListItem);
...
var React = __webpack_require__(1);
var PropTypes = __webpack_require__(4);
var UserListItem = __webpack_require__(88);
var ReloadButton = __webpack_require__(86);
...
var UsersList = function (_React$Component) {
  ...
  _createClass(UsersList, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        'section',
        { className: 'container users-list' },
        React.createElement(
          'h1',
          null,
          'Employee Data',
          React.createElement(ReloadButton, null)
        ),
        React.createElement(
          'div',
          ...
          React.createElement(
            'div',
            { className: 'col-md-2 sortable', onClick: function onClick() {
                return _this2.sort('firstname');
              } },
            'First Name'
          ),
          React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'col-md-2 sortable', onClick: function onClick() {
                return _this2.sort('contact_number');
              } },
            'Contact Number'
          ),
          React.createElement(
            'div',
            { className: 'col-md-2 sortable', onClick: function onClick() {
                return _this2.sort('email');
              } },
            'Email'
          ),
          React.createElement(
            'div',
            { className: 'col-md-2 sortable col-md-offset-1 icon-delete-header' },
            'Delete'
          )
        ),
        this.props.users.map(function (user) {
          return React.createElement(UserListItem, { key: user.email, user: user });
        })
      );
    }
  }]);
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ fetchUsers: fetchUsers, sort: sort }, dispatch);
}
...
var usersReducer = __webpack_require__(95);
var selectedUserReducer = __webpack_require__(94);
var addedUserReducer = __webpack_require__(90);
var editedUserReducer = __webpack_require__(92);
var deletedUserReducer = __webpack_require__(91);
var validationErrorReducer = __webpack_require__(96);
...
function usersReducer() {
  ...
  var cloneState = function cloneState() {
  ...
  switch (action.type) {
    ...
    case EDIT_USER:
      var clonedUpdatedState = cloneState();
      var indexUpdated = clonedUpdatedState.findIndex(function (user) {
        return user.email === action.payload.data.email;
      });
    ...
    case DELETE_USER:
      var clonedDeletedState = cloneState();
      var indexDeleted = clonedDeletedState.findIndex(function (user) {
        return user.email === action.payload.data.email;
      });
      clonedDeletedState.splice(indexDeleted, 1);
      return clonedDeletedState;
    case SORT:
      var clonedSortedState = cloneState();
      clonedSortedState.sort(function (a, b) {
...
// app
var startApp = __webpack_require__(23);
